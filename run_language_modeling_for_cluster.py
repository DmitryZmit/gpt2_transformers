...
def main():
    ...
    parser.add_argument("--warmup_samples", default=0, type=int, help="Linear warmup over warmup_steps.")
    ...
    parser.add_argument("--use_cluster", action="store_true", help="use_cluster",)
